...
<head>
    ...
    <title>king egy car store</title>
    <meta charset="UTF-8">
    ...
    <div>
        ...
        <div class="container main">
            <div class="jumbotron">
                ...
                <p>The largest Arab site for the purchase of auto parts</p>
            </div>
        </div>
        <div class="container products">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/car ls.jpg" alt="dmax2020">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/اقصدام امامي ديمكس 2019.jpg" alt="Sony DSLR">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/كراتين ابواب ls 2020.jpg" alt="Sony DSLR">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/كراتين ابواب ls ووحدة رفع ازاز كهربا.jpg" alt="Olympus">
                        </a>
                        <center>
                            <div class="caption">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/ابواب ديمكس.jpg" alt="Titan 301">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/وحدة رفع ازاز كهربا.jpg" alt="Titan 201">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/شفورليه2.png" alt="htm milan">
                        </a>
                        <center>
                            <div class="caption">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            ...
                            <img src="img/car-10.webp" alt="titan">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail">
                        <a href="cart.php">
                            <img src="img/حاملين فوانيس اماميه سيات اتيكا من ٢٠١٦ حتي ٢٠٢٠.png" alt="Titan 201">
                        </a>
                        <center>
                            <div class="caption">
